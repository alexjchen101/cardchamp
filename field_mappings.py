...
def _hubspot_pos_rules():
    ...
    return [
        ...
        ("Clover POS", lambda s, r, t: not_gw(t) and "clover" in s),
        ...
        ("Cardpointe Ingenico iCT220", lambda s, r, t: not_gw(t) and "ingenico" in s),
        ...
        ("PAX S80", lambda s, r, t: not_gw(t) and "pax" in s),
        ...
        ("Credit Card Machine - General", lambda s, r, t: not_gw(t) and ("idtech" in s or "vp3350" in s or "magtek" in s or "usb wedge" in s or ("encrypt" in s and "usb" in s))),
